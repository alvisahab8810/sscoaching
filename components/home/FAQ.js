...
const faqData = [
  ...
  {
    q: "How can I take NIOS admission through SS Coaching?",
    a: "Simply visit your nearest SS Coaching branch — conveniently located at Hazratganj, Indiranagar, and Alambagh, three of Lucknow's most accessible prime locations. Our counselors will guide you through subject selection and complete NIOS enrollment on the same day — no complicated paperwork involved.",
  },
  {
    q: "What is the last date for NIOS admission?",
    a: "NIOS admission is open throughout the year. However, specific exam cycles have their own deadlines. With 25+ years of NIOS admission experience, SS Coaching counselors will confirm the current admission window immediately and ensure you never miss your exam cycle.",
  },
  {
    q: "What is TMA in NIOS and is it compulsory?",
    a: "TMA stands for Tutor Marked Assignment. It is mandatory for every NIOS subject and contributes marks to your final result. SS Coaching provides complete TMA guidance, solved samples, and submission support — backed by 25+ years of NIOS assignment expertise — so students never lose marks on assignments.",
  },
  {
    q: "How many subjects do I need to pass in NIOS Class 10 and Class 12?",
    a: "NIOS Secondary (Class 10) and Sr. Secondary (Class 12) students both need to pass 5 subjects to receive their certificate. SS Coaching's experienced faculty personally guides every student toward the most scoring and manageable subject combination based on their academic background.",
  },
  {
    q: "Can I transfer subjects I already passed from CBSE or State Board to NIOS?",
    a: "Yes. NIOS allows Transfer of Credit (TOC) for up to 2 subjects already passed from recognised boards including CBSE, ICSE, and State Boards. SS Coaching counselors — with 25+ years of NIOS admission experience — help students correctly apply TOC and reduce their exam burden significantly.",
  },
  {
    q: "How many times can I appear in NIOS board exams in a year?",
    a: "NIOS conducts public examinations twice a year — in April and October. Students can choose their preferred exam cycle at the time of admission. SS Coaching's structured preparation classes ensure students are fully exam-ready well before every public examination date.",
  },
  {
    q: "Does SS Coaching offer online NIOS classes?",
    a: "Yes. SS Coaching offers fully equipped online NIOS classes with high-tech smart coaching technology — giving students the same quality of learning from home as they would receive in our physical centres. Online students receive the same study materials, TMA support, and faculty guidance as classroom students.",
  },
  {
    q: "What facilities does SS Coaching provide at its coaching centres?",
    a: "SS Coaching's three centres — located at Hazratganj, Indiranagar, and Alambagh — offer fully air-conditioned, clean, and calm classrooms designed for distraction-free NIOS preparation. Each centre is equipped with high-tech smart teaching equipment, a dedicated student library, and experienced NIOS faculty — all at genuinely affordable fees accessible to every student.",
  },
  {
    q: "Is a gap year a problem for NIOS admission?",
    a: "No. NIOS has no age bar or gap year restriction for Secondary and Sr. Secondary admission. Students who dropped out years ago can still enroll and complete their board certification without any academic penalty. SS Coaching has successfully guided thousands of gap-year and overage students back into education over 25+ years.",
  },
  {
    q: "Why should I choose SS Coaching for NIOS preparation in Lucknow?",
    a: "SS Coaching brings together everything a NIOS student needs — 25+ years of experience, affordable fee structure, three prime location branches at Hazratganj, Indiranagar, and Alambagh, fully AC smart classrooms, online classes with high-tech equipment, NIOS-specific study materials, TMA support, and a proven track record of 100,000+ students passed. No other NIOS coaching centre in Lucknow offers this complete combination.",
  },
];
        ...
        <div className="container">
          <div className="faq-container">
            ...
            <p className="faq-subtitle">
              Everything failed students, dropouts, and private candidates ask before joining SS Coaching — Lucknow&apos;s most trusted NIOS coaching centre with 25+ years of experience.
            </p>
