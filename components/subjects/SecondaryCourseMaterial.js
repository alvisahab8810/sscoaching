  ...
  const subjects = [
    {
      code: 201,
      name: "Hindi",
      url: "/subject/secondary-course-material/hindi201",
    },
    {
      code: 202,
      name: "English",
      url: "/subject/secondary-course-material/english202",
    },

    {
      code: 213,
      name: "Social Science",
      url: "/subject/secondary-course-material/socialscience213",
    },
...

    {
      ...
      url: "/subject/secondary-course-material/ich223",
    },
              ...
              {subjects.map((subj, index) => (
                <tr key={index} className={index % 2 === 0 ? "even-row" : ""}>
                  ...
                  <td className="text-center">
                    <a
                      href={subj.url}
                      target={subj.url.startsWith("/") ? "_self" : "_blank"}
                      rel="noopener noreferrer"
                      className="link-text"
                    >
                      Click Here
