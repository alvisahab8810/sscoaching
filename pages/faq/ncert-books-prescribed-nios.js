...
export default function SpecialTextBooksNIOS() {
  return (
    <>
      <Head>
        <title>Are there any special text books prescribed by the board for NIOS Exams?</title>
        <meta
          name="description"
          content="Are there any special text books prescribed by the board for NIOS Exams? Complete details about NIOS study material and syllabus."
        />
      ...
      <section className="home-page-area syllabus-nios1">
        ...
        <div className="syllabus-nios">
          <div className="container">
            ...
            <p>
              There are no special text books prescribed by NIOS board, the study material provided by NIOS is more than enough for a student to gain knowledge and understand the subject properly. The books for NIOS are specially designed by NCERT (National council of Education Research and Training) so as to make the students understand the subject properly and gain maximum knowledge without any assistance.
            </p>


            <p>
              NIOS is a premier open and distance learning (ODL) institution in the country in the school education sector. It is mandated not only to offer courses at the pre-degree level with emphasis on skill development both at the secondary and senior secondary level, but also promote school education across states. In light of the recent developments, such as the enactment of the Right to Education Act by the Parliament, introduction of NCF 2005 and introduction of the Continuous and Comprehensive Evaluation (CCE) at the elementary and secondary stages, NIOS needs to revisit not only its curriculum on open basic education and other levels but also develop a system of parity with emphasis on vocationalising secondary and senior secondary levels.
            </p>
            ...
            <h3 className="nios-125h-senior-hero-title">Class - X :</h3>

            <p>
              English, Hindi, Science , Social Science, Mathematics, Home Science, Business Studies, Economics, Indian Heritage & Culture, Word Processing, Sanskrit, Psychology, Punjabi etc.
            </p>

            <h3 className="nios-125h-senior-hero-title">Class - XII :</h3>

            <p>
              English, Hindi, Political Science, History, Economics, Business Studies, Accountancy, Physics, Chemistry, Biology, Mathematics, Home Science, Psychology, Sociology, Geography, Word Processing, Computer Science Typing etc.
            </p>

            <p>
              Nearly All the Books are available in English & Hindi Medium and some books are even available in Punjabi Medium also. Our website is a great source of understanding and being Suggested by Various NIOS Coaching Institutes, Tuition Centers, Teachers & Study Centers and are also preferred by the NIOS Students as Teachers & Students have Found them Most Suitable for Easy Study & Most Useful for preparing and taking admission for the NIOS Exams.
            </p>
