...
export default function NIOSDegreeImportance() {
  return (
    <>
      <Head>
        <title>
          Whether Secondary Senior Secondary School degrees received from NIOS carry the same importance as other boards?
        </title>
        <meta
          name="description"
          content="Do Secondary and Senior Secondary degrees from NIOS carry the same importance as other boards like CBSE and ICSE?"
        />
      ...
      <section className="home-page-area syllabus-nios1">
        ...
        <div className="syllabus-nios">
          <div className="container">
            ...
            <h3 className="nios-125h-senior-hero-title">Group-A:</h3>
            ...
            <h3 className="nios-125h-senior-hero-title">Group-B:</h3>
            ...
            <p>
              If you have any inquiries related to NIOS admission or NIOS programs, please do not hesitate to contact us through our website http://sscoaching.in/ or by phone at <strong>9839065533</strong> (SS Coaching Institute, Lucknow).
            </p>
