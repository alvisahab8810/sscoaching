...
export default function OpenBasicEducationNIOS() {
  return (
    <>
      <Head>
        <title>
        ...
        <meta
          name="description"
          content="Know about Open Basic Education (OBE) programme in NIOS including eligibility, levels and flexibility."
        />
