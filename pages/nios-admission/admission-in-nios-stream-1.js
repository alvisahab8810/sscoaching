          ...
          <div className="documents-section">
            ...
            <div className="documents-cards">
              <div className="document-card">
                ...
                <p className="document-card-text">
                  Birth Certificate form Nursing Home/First Class
                  Magistrate/Nagar Nigam/Aadhar Card/any ID Proof.
                  <br />
                  8th Class Pass Transfer Certificate.
                  <br />6 Colored passport size photographs along with Name and
                  Date.
                  <br />
                  Guardian/Parents Address proof (Photocopy) except Driving
                  License.
                </p>
              </div>
              <div className="document-card">
      ...
      <div className="container">
        <div className="why-nios-section">
          ...
          <p className="why-nios-text">
            ...
            and tuition classes for secondary class (10th) and senior secondary
            class (12th). SS Coaching NIOS lucknow centre, also helps students
            to fill the online admission forms in streams 1, streams 2, streams
            3 & 4 of the NIOS Board for qualifying 10th and 12th class.
          </p>
        </div>
      </div>
