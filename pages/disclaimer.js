...
export default function DisclaimerPage() {
  return (
    <>
      <Head>
        <title>SS Coaching Disclaimer and Copyright</title>
      </Head>
        ...
        <div className="syllabus-nios">
          <div className="container">
            <h1 className="nios-125h-senior-hero-title">
              SS Coaching Disclaimer and Copyright
            </h1>

            <p>
              Welcome to our website. If you continue to browse and use this
              website, you are agreeing to comply with and be bound by the
              following disclaimer policies, terms and conditions of use, which
              together with our privacy policy govern The SS Coaching's
            ...
            <p>
              The term <strong>“SS Coaching”</strong> or ‘us’ or ‘we’ refers to the owner of the
              website whose registered office is given IIIrd Floor, Shree
              Chamber, Naza Computer Market, Near Basant Cinema Lucknow. The
            ...
            <img src="/assets/images/others/copyright.jpg"></img>
            <br/>
            ...
            <p>
              ...
              of the website is subject to the laws of Lucknow, Uttar Pradesh,
              India
            </p>
          </div>
        </div>
