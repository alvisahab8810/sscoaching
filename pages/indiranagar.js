...
const whys = [
  ...
  { icon: "📍", color: "purple", title: "Prime Lucknow Location", desc: "Conveniently located in Indiranagar — well connected by metro and bus routes from all parts of Lucknow." },
...
const results = [
  { num: "01", name: "Rohit Sharma", roll: "210274233051", cls: "12th Commerce", score: "93.6%" },
  { num: "02", name: "Pooja Singh", roll: "210274233082", cls: "12th Science", score: "92.4%" },
  { num: "03", name: "Aryan Verma", roll: "210274233107", cls: "12th Commerce", score: "91.2%" },
  { num: "04", name: "Sneha Gupta", roll: "210274233134", cls: "10th Science", score: "90.8%" },
  { num: "05", name: "Kartik Mishra", roll: "210274233156", cls: "10th Arts", score: "88.6%" },
  { num: "06", name: "Divya Yadav", roll: "210274233178", cls: "12th Arts", score: "87.0%" },
  { num: "07", name: "Ankit Tiwari", roll: "210274233199", cls: "10th Commerce", score: "85.4%" },
];
    ...
    <div className="hg-page">
        ...
        <div className="container">
          <div className="hg-hero-in">
            <div className="hg-hero-left">
              <div className="hg-chip"><span className="hg-dot" />Indiranagar Branch · Lucknow</div>

              {/* Desktop */}
              <div className="mobile-none">
                <h1 className="hg-h1">
                  A <span className="hg-accent">Bright Future</span><br />Starts Here at<br />SS Coaching
                </h1>
                <p className="hg-hero-sub">
                  Pass your 10th or 12th the smart way — with Lucknow's most trusted<br />
                  NIOS coaching centre. Since 2001, <strong>10,000+ students</strong> have rewritten their future with us.
                </p>
              </div>
              ...
              <div className="desktop-none">
                <h1 className="hg-h1">
                  A <span className="hg-accent">Bright Future</span> Starts Here at SS Coaching
                </h1>
                <p className="hg-hero-sub">
                  Pass your 10th or 12th the smart way — with Lucknow's most trusted NIOS coaching centre. Since 2001, <strong>10,000+ students</strong> have rewritten their future with us.
                </p>
              </div>
              ...
              <div className="hg-hbtns">
                ...
                <a href="tel:+919839065533" className="hg-btn-wh">Call Now</a>
              </div>
            </div>

            {/* Info Card */}
            <div className="hg-hcard">
              <div className="hg-hcard-ttl text-center">Indiranagar Branch Info</div>
              <div className="hg-hrow">
                <div className="hg-hico"><FaMapMarkerAlt className="text-red-500" /></div>
                <div className="hg-hbody">
                  <strong>Address</strong>
                  <span>Sector 9, Near Lekhraj Market,<br />Indiranagar, Lucknow – 226016</span>
                </div>
              </div>
              <div className="hg-hrow">
                <div className="hg-hico"><FaPhoneAlt className="text-green-600" /></div>
                <div className="hg-hbody">
              ...
              <div className="hg-hrow">
                <div className="hg-hico"><FaClock className="text-blue-500" /></div>
                <div className="hg-hbody">
              ...
              <div className="hg-hrow">
                <div className="hg-hico"><FaBus className="text-yellow-500" /></div>
                <div className="hg-hbody">
                  <strong>How to Reach</strong>
                  <span>Near Lekhraj Metro Station<br />Easy access from Gomti Nagar & Hazratganj</span>
                </div>
              </div>
              <div className="hg-hmini">
                <a href="tel:+919839065533" className="hg-mbtn hg-mbl">
                  <FaPhoneAlt className="text-green-600" /> Call Us
                </a>
                <a href="https://wa.me/919839065533" className="hg-mbtn hg-mtl">
                  <FaWhatsapp className="text-green-500 whatsppp-ico" /> WhatsApp
                </a>
              </div>
            </div>
          </div>
            ...
            {admitData.map((a) => (
              <a key={a.title} href="#streams" className={`hg-ac ${a.cls}`}>
                <span className="hg-ac-ico">
                  <Image src={a.icon} alt={a.title} width={30} height={30} />
                </span>
        ...
        <div className="hg-sec">
          <div className="hg-sh">
            ...
            <p className="hg-sdesc">
              Every topper at SS Coaching Indiranagar is proof that the right guidance changes everything. Meet our 2024 stars.
            </p>
          </div>
          <StudentSuccess />
        </div>
        ...
        <div className="hg-reg-in">
          <div className="hg-reg-l">
            ...
            <div className="hg-reg-btns">
              <a href="tel:+919839065533" className="hg-btn-yl">Enrol Now →</a>
      ...
      <section className="hg-section hg-bg-off" id="results">
        <div className="hg-sec">
          <div className="hg-sh">
            ...
            <p className="hg-sdesc">A glimpse of our 2024 toppers from SS Coaching Indiranagar.</p>
          </div>
          <div className="container">
            <div className="hg-table-wrap">
              <table className="hg-rtable">
                <thead>
                  <tr><th>#</th><th>Student Name</th><th>Roll Number</th><th>Class / Stream</th><th>Score</th></tr>
                </thead>
                <tbody>
                  {results.map((r) => (
                    <tr key={r.num}>
      ...
      <div className="hg-reg hg-reg-green">
        <div className="hg-reg-in">
          <div className="hg-reg-l">
            ...
            <div className="hg-reg-btns">
              <a href="tel:+919839065533" className="hg-btn-yl">Book Free Counselling →</a>
      ...
      <section className="hg-section" id="faq">
        <div className="hg-sec">
          <div className="hg-sh">
            ...
            <p className="hg-sdesc">Everything you want to know before enrolling at SS Coaching Indiranagar.</p>
          </div>
          <div className="container">
            <div className="hg-fq-grid">
              {faqs.map((f, i) => (
                <div key={`faq-${i}`} className={`hg-fqi ${openFaq === i ? "hg-fqi-open" : ""}`}>
                ...
                {[
                  {
                    ico: <FaMapMarkerAlt />,
                    label: "Address",
                    content: <span>Sector 9, Near Lekhraj Market, Indiranagar, Lucknow – 226016</span>,
                  },
                  {
                    ico: <FaPhoneAlt />,
      ...
      <div className="ob">
        <div className="ob-in">
          ...
          <div className="b-row">
            <a href="/hazratganj" className="bcard">
              <div>
            ...
            <a href="/alambagh" className="bcard">
              <div>
